...
import './StreamVidPlayer.css';

interface StreamVidPlayerProps {
  src: string;
  poster?: string;
  autoplay?: boolean;
}

export default function StreamVidPlayer({ src, poster, autoplay = false }: StreamVidPlayerProps) {
  ...
  useEffect(() => {
    if (!playerRef.current && videoRef.current) {
      ...
      player.addClass('vjs-streamvid-skin');
      playerRef.current = player;

      player.ready(function() {
        console.log('StreamVid Player is ready');
  ...
  return (
    <div data-vjs-player className="w-full h-full streamvid-container">
      <video
        ref={videoRef}
